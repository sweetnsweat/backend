...
class HomeControllerTest {
    ...
    void worldBannersReturnsDefaultThreeActiveSlides() throws Exception {
        ...
        mockMvc.perform(get("/api/home/world-banners")
                ...
                .andExpect(jsonPath("$.data.slides[0].imageUrl").value("/media/assets/character_cheon.png"))
                .andExpect(jsonPath("$.data.slides[0].backgroundImageUrl").value("/media/assets/world_4.png"))
